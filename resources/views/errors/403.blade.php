...
<body class="bg-gradient-to-br from-slate-800 via-slate-900 to-gray-900 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full">
        <div class="glass-card rounded-2xl p-8 text-center shadow-xl fade-in">
            <div class="mb-6">
                <div class="mx-auto w-20 h-20 bg-orange-500/20 rounded-full flex items-center justify-center floating border border-orange-500/30">
            ...
            <p class="text-gray-300 mb-6 text-base leading-relaxed">
                Maaf, kamu gak punya izin untuk akses halaman ini.
                <br><span class="text-orange-300">Coba login dulu atau hubungi admin ya! 🔐</span>
            </p>
            
            <div class="bg-white/5 rounded-lg p-4 mb-6 border border-white/10">
                <div class="text-orange-300 font-mono text-sm font-medium">
                    <i class="fas fa-shield-alt mr-2"></i>
                    Error Code: 403
                </div>
                <div class="text-gray-400 text-xs mt-1">Forbidden Access</div>
            </div>
            
            <div class="space-y-3">
                <button onclick="history.back()" 
                        class="w-full bg-orange-600 hover:bg-orange-700 text-white font-medium py-3 px-6 rounded-lg button-hover flex items-center justify-center gap-2">
